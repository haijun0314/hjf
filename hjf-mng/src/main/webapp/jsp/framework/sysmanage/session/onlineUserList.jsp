...
<script>
	HJF.pageRequest("${pm.curPage}","${pm.totalPage}","/sys/sysUser?onlineUserList&ajax=true&reqType=1&ajax=true");
	...
	function searchSubmit(){
		AjaxRequest.urlRequest("/sys/sysUser?onlineUserList&ajax=true&reqType=1");
	}
</script>
